...
urlpatterns = [
    ...
    path("face-id/register/begin/", views.face_id_register_begin, name='face_id_register_begin'),
    path("face-id/register/finish/", views.face_id_register_finish, name='face_id_register_finish'),
    path("face-id/login/begin/", views.face_id_login_begin, name='face_id_login_begin'),
    path("face-id/login/finish/", views.face_id_login_finish, name='face_id_login_finish'),
    ...
    path("attendance/self-reports/", hod_views.admin_view_student_self_reports,
         name="admin_view_student_self_reports",),
    ...
    path("staff/view/student-self-reports/", staff_views.staff_view_student_self_reports,
         name="staff_view_student_self_reports"),
    ...
    path("student/report/attendance/", student_views.student_report_attendance,
         name='student_report_attendance'),
